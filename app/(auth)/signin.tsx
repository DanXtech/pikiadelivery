    ...
    <KeyboardAvoidingView style={styles.container} >
      ...
      >
        ...
        <View style={styles.formContainer}>
          ...
          <Link href="/(root)/(tabs)" style={styles.loginButton}>
            <Text style={styles.textBtn}>Login</Text>
          </Link>

          <Animated.View style={styles.optionLine} entering={FadeInDown.delay(1300).duration(500)}>
            ...
            <TouchableOpacity>
              <Link href="/signup" asChild>
                <Text style={styles.loginText}>
                  Don't have account? <Text style={styles.text}>Sign Up</Text>
                </Text>
              </Link>
            </TouchableOpacity>
          </Animated.View>
