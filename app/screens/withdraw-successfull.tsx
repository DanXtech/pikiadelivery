...
const WithdrawSuccessFull = () => {
    ...
    const handleDonePress = () => {
        ...
        router.push('/(root)/(tabs)/earnings');
    };
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <View style={styles.confirmationContainer}>
                    ...
                    >
                        <Text style={styles.boldText}>$250 </Text> has been sent to <Text style={styles.boldText}>UKAEGBU Great junior</Text> of <Text style={styles.boldText}>BARCLAY BANK</Text>
                    </Animated.Text>
                </View>
            </View>
        </SafeAreaView>
